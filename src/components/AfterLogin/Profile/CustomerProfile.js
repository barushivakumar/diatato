      ...
      useEffect(() => {
        ...
        async function fetchServicesData() {
          ...
          try {
            ...
            await console.log(response.data,"Profile Data",response.data.userProfile.current_town);
      ...
      >
        {imageUrl ? (
          ...
          uploadButton
            ...
            <div className="mb-5">
                <Link to="/EditCustomerProfile" style={{...ButtoninputStyle,textDecoration:'none',textAlign:'center',color:'white'}} type="submit" className="buttonUI ">Edit Property</Link>
            </div>
...
export default connect() (CustomerProfile);